...
DJANGO_SUPERUSER_EMAIL=blank@noemail.com DJANGO_SUPERUSER_USERNAME=admin DJANGO_SUPERUSER_PASSWORD=dmvwatchclub1234 python manage.py createsuperuser --noinput
